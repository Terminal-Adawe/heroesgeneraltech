  ...
  C80.2,0,80.1,0,80,0z"></path></svg>
        ...
        <div class="u-align-left u-container-style u-expanded-width-sm u-expanded-width-xs u-grey-5 u-group u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h2 class="u-text u-text-default u-text-palette-2-base u-text-1">Login</h2>
            <p class="u-text u-text-2">Login now to see your products or updates on ongoing projects.</p>
            <a href="{{ route('register') }}" class="u-active-white u-border-2 u-border-palette-2-base u-btn u-button-style u-color-scheme-summer-time u-color-style-multicolor-1 u-custom-font u-font-oswald u-hover-black u-none u-text-active-grey-10 u-text-body-color u-text-hover-grey-10 u-btn-1">Sign up now</a>
            <p class="u-text u-text-3">Already have an account? <a href="{{ route('login') }}" class="u-active-none u-border-1 u-border-active-grey-50 u-border-black u-border-hover-grey-50 u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn-2" target="_blank">Login</a>
            </p>
          </div>
        </div>
      </div>
